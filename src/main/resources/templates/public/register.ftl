...
<@layout.page title="Registrazione" active="registrazione">
<section class="page-heading">
    <p class="eyebrow">Nuovo cliente</p>
    <h1>Registrazione</h1>
    <p>Crea un account per aggiungere prodotti al carrello e completare l'acquisto.</p>
</section>

<section class="auth-panel auth-panel--wide" aria-label="Registrazione cliente">
    ...
    <form class="auth-form" method="post" action="${contextPath}/registrazione">
        ...
        <div class="auth-form__actions">
            ...
            <a class="button button--ghost" href="${contextPath}/login">Hai gia un account?</a>
