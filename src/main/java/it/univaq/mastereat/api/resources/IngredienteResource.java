...
@Path("/prodotti/{idProdotto}/ingredienti")
...
public class IngredienteResource {
    ...
    @GET
    public Response getIngredientiByProdottoId(@HeaderParam("Authorization") String authorizationHeader,
        ...
        try {
            ...
            return Response.ok(prodottoService.getIngredientiProdotto(idUtente.get(), idProdotto)).build();
            ...
            return internalServerError("Errore interno durante il recupero degli ingredienti");
        }
    }
